...
public class BackGround {
    ...
    public BackGround(Resources res,Bitmap bmpBackground,int screenW,int screenH)
    {
        this.res=res;
        ...
        backX1=-(Math.abs(bmpBackground1.getWidth()-screenW))+2;
        backX2=backX1-bmpBackground1.getWidth()+2;
        backX3=backX1+bmpBackground1.getWidth()-2;
    }
    ...
    public void logic(int duraction)
    {
        if(duraction== Constants.MOVE_LEFT)
        {
            ...
            //立即将第三张坐标设置到第二张图的左方
            if (backX1 > screenW) {
                backX3 = backX2 - bmpBackground1.getWidth()+2;
            }
            //当第二张图片的Y坐标超出屏幕，
            //立即将第一张图片坐标设置到第三张图的左方
            if (backX2 > screenW) {
                backX1 = backX3 - bmpBackground1.getWidth()+2;
            }
            //当第三张图片的Y坐标超出屏幕，
            //立即将第二张坐标设置到第一张图的上方
            if(backX3>screenW){
        ...
        else if(duraction==Constants.MOVE_RIGHT)
        {
            ...
            if (backX1 <(- bmpBackground1.getWidth())) {
                backX2 = backX3 + bmpBackground1.getWidth()-2;
            }
            //当第二张图片的Y坐标超出屏幕，
            //立即将第三张坐标设置到第一张图的右方
            ...
            if (backX3 <(- bmpBackground1.getWidth())) {
                backX1 = backX2 + bmpBackground1.getWidth()-2;
            }
        }
    }
